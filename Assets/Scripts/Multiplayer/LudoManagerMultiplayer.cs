...
public class LudoManagerMultiplayer : MonoBehaviour
{
	...
	{
		if (playerTurn == "RED" && NetworkManager.playAsRedPlayer || playerTurn == "BLUE" && NetworkManager.playAsBluePlayer || playerTurn == "GREEN" && NetworkManager.playAsGreenPlayer || playerTurn == "YELLOW" && NetworkManager.playAsYellowPlayer)
		{
			...
			Debug.Log("SelectDice = " + selectDiceNumAnimation);

			//StartCoroutine("PlayersNotInitialized");
			photonView.RPC("PlayersNotInitializedMethod", RpcTarget.All, selectDiceNumAnimation, playerTurn);
		}
	}

	[PunRPC]
	public void PlayersNotInitializedMethod(int diceNumber, string whoIsPlaying)
    {
	...
	IEnumerator PlayersNotInitialized()
	{
		...
		Debug.Log("initial player turn = " + playerTurn);
		...
		switch (playerTurn)
		{
			...
			case "YELLOW":
				...
				photonView.RPC("SetDice", RpcTarget.All);
		}
	}
	...
	public void redPlayerI_UI_Button()
    {
		if (playerTurn == "RED" && NetworkManager.playAsRedPlayer)
		{
			photonView.RPC("redPlayerI_UI", RpcTarget.All);
		}
	}
	 ...
	 public void redPlayerI_UI()
	{
			...
			if (playerTurn == "RED" && (redMovementBlocks.Count - redPlayerI_Steps) > selectDiceNumAnimation) // 4 > 4
			{
				...
				else
				{
					if (selectDiceNumAnimation == 6 && redPlayerI_Steps == 0)
					{
						Vector3[] redPlayer_Path1 = new Vector3[selectDiceNumAnimation];
						redPlayer_Path1[0] = redMovementBlocks[redPlayerI_Steps].transform.position;
						redPlayerI_Steps += 1;
						playerTurn = "RED";
						//currentPlayer = RedPlayerI_Script.redPlayerI_ColName;
						currentPlayerName = "RED PLAYER I";
						iTween.MoveTo(redPlayerI, iTween.Hash("position", redPlayer_Path1[0], "speed", 125, "time", 2.0f, "easetype", "elastic", "looptype", "none", "oncomplete", "InitializeDice", "oncompletetarget", this.gameObject));
					}
				}
			}
			else
	...
	public void redPlayerII_UI_Button()
	{
		if (playerTurn == "RED" && NetworkManager.playAsRedPlayer)
		{
			photonView.RPC("redPlayerII_UI", RpcTarget.All);
		}
	}
	...
	public void redPlayerIII_UI_Button()
	{
		if (playerTurn == "RED" && NetworkManager.playAsRedPlayer)
		{
			photonView.RPC("redPlayerIII_UI", RpcTarget.All);
		}
	}
	...
	public void redPlayerIV_UI_Button()
	{
		if (playerTurn == "RED" && NetworkManager.playAsRedPlayer)
		{
			photonView.RPC("redPlayerIV_UI", RpcTarget.All); 
		}
	}
	...
	public void redPlayerIV_UI()
	{
			...
			else
			{
				...
				Debug.Log("next player turn = " + playerTurn);
			}
		
	}
	//==================================== GREEN PLAYERS MOVEMENT =================================================================

	public void greenPlayerI_UI_Button()
	{
		if (playerTurn == "GREEN" && NetworkManager.playAsGreenPlayer)
		{
			photonView.RPC("greenPlayerI_UI", RpcTarget.All);
		}
	}
	...
	public void greenPlayerII_UI_Button()
	{
		if (playerTurn == "GREEN" && NetworkManager.playAsGreenPlayer)
		{
			photonView.RPC("greenPlayerII_UI", RpcTarget.All);
		}
	}
	...
	public void greenPlayerIII_UI_Button()
	{
		if (playerTurn == "GREEN" && NetworkManager.playAsGreenPlayer)
		{
			photonView.RPC("greenPlayerIII_UI", RpcTarget.All);
		}
	}
	...
	public void greenPlayerIV_UI_Button()
	{
		if (playerTurn == "GREEN" && NetworkManager.playAsGreenPlayer)
		{
			photonView.RPC("greenPlayerIV_UI", RpcTarget.All);
		}
	}
	...
	public void bluePlayerI_UI_Button()
	{
		if (playerTurn == "BLUE" && NetworkManager.playAsBluePlayer)
		{
			photonView.RPC("bluePlayerI_UI", RpcTarget.All);
		}
	}
	...
	public void bluePlayerII_UI_Button()
	{
		if (playerTurn == "BLUE" && NetworkManager.playAsBluePlayer)
		{
			photonView.RPC("bluePlayerII_UI", RpcTarget.All);
		}
	}
	...
	public void bluePlayerIII_UI_Button()
	{
		if (playerTurn == "BLUE" && NetworkManager.playAsBluePlayer)
		{
			photonView.RPC("bluePlayerIII_UI", RpcTarget.All);
		}
	}
	...
	public void bluePlayerIV_UI_Button()
	{
		if (playerTurn == "BLUE" && NetworkManager.playAsBluePlayer)
		{
			photonView.RPC("bluePlayerIV_UI", RpcTarget.All);
		}
	}
	...
	public void yellowPlayerI_UI_Button()
	{
		if (playerTurn == "YELLOW" && NetworkManager.playAsYellowPlayer)
		{
			photonView.RPC("yellowPlayerI_UI", RpcTarget.All);
		}
	}
	...
	public void yellowPlayerII_UI_Button()
	{
		if (playerTurn == "YELLOW" && NetworkManager.playAsYellowPlayer)
		{
			photonView.RPC("yellowPlayerII_UI", RpcTarget.All);
		}
	}
	...
	public void yellowPlayerIII_UI_Button()
	{
		if (playerTurn == "YELLOW" && NetworkManager.playAsYellowPlayer)
		{
			photonView.RPC("yellowPlayerIII_UI", RpcTarget.All);
		}
	}
	...
	public void yellowPlayerIV_UI_Button()
	{
		if (playerTurn == "YELLOW" && NetworkManager.playAsYellowPlayer)
		{
			photonView.RPC("yellowPlayerIV_UI", RpcTarget.All);
		}
	}
